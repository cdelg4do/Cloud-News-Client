...
//  Cloud News
//
//  Created by Carlos Delgado on 29/10/16.
//  Copyright © 2016 cdelg4do. All rights reserved.
//

import UIKit

class WriterTableViewController: UITableViewController {
    ...
    var btnToggleSession: UIBarButtonItem?
    var btnCreateArticle: UIBarButtonItem?
    var btnDraft: UIBarButtonItem?
    var btnSubmitted: UIBarButtonItem?
    var btnPublished: UIBarButtonItem?
    ...
    // MARK: Manejo de la sesión de usuario
